...
export function ReasoningCard({ 
  ...
  const [hasRespondedToAutoCollapse, setHasRespondedToAutoCollapse] = useState(false);
  ...
  }, [reasoningSegments, isComplete, title, isCollapsed, autoCollapsed, shouldAutoCollapse, hasRespondedToAutoCollapse]);
  ...
  const renderReasoningContent = (content: string) => {
    ...
    const hasStrongTags = /<strong>|<\/strong>|<b>|<\/b>/i.test(unwrappedContent);
    ...
    const forceHtmlRendering = hasHtmlTags || hasStrongTags || hasEmTags || hasHtmlEntities || hasStyleAttr;
