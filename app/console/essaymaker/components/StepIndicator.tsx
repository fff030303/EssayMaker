              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    ${isCurrentStep ? "bg-stone-600" : "bg-stone-200"}`}
                  >
                    <span
                      className={`text-xs font-medium
                      ${isCurrentStep ? "text-white" : "text-stone-700"}`}
                    >
                      {index + 1}
                    </span>
                  </div>
                  ...
                  <div
                    ...
                    ${isCurrentStep ? "bg-stone-50/80" : "bg-background"}
                    ${isExpanded ? "shadow-sm border border-stone-300" : ""}`}
                  >
                    <div
